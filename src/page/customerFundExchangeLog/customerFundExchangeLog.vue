        ...
        >
            ...
            <group v-for="item in list">
                ...
                <cell-form-preview  @click.native="showItems(item)" :list="[
                    {label: '兑换金额',value: item.to.value+'('+mapping.currencyCnName[item.to.name]+')'},
                    {label: '状态',value: mapping.currency_state[item.state]}]"></cell-form-preview>
            </group>
        ...
        <div v-transfer-dom>
            <popup v-model="detailShow" position="left" width="100%">
                <div class="position-horizontal-demo">
                    ...
                    <group>
                        <div >
                            <cell title="状态" :value="mapping.currency_state[detail.state]"></cell>
                            <cell-form-preview :list="[
                                {label: '编号',value: detail.order_num},
                                {label: '兑换金额',value: detail.to.value+'('+mapping.currencyCnName[detail.to.name]+')'},
