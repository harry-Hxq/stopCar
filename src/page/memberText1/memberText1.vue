<template>
    <div>
        ...
        <div class="memberContent1">
            <ul>
                <li>停车无忧会员的年服务费用为118一年。（付费当日开始计时，年周期为365天）</li>
                <li>车主在停车期间若无交警贴罚单，则不提醒、不计数、也不收费，但是又实时看护车主可安心停放 。</li>
                <li>无限使用无忧停车次数，系统只按提醒次数计费。</li>
                <li>若一年内提醒次数少于50次，则每次按2元收费，剩余费用可直接点击退款。超过50次则年费抵除，不再另收费。</li>
                <li>费用的结算周期为365天。</li>
            </ul>
        </div>
